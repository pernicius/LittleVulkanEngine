...
namespace lve {
		...
		const PipelineConfigInfo& configInfo)
	{
		...
		LOG_VULKAN("Vertex Shader Code Size: " << vertCode.size());
		LOG_VULKAN("Fragment Shader Code Size: " << fragCode.size());
